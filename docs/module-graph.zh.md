...
flowchart TD
  ...
  pkg_llm_gemini --> pkg_credentials
  pkg_llm_gemini --> pkg_invariants
  pkg_llm_gemini --> pkg_llm
  pkg_llm_gemini --> pkg_settings
...
| [`llm-gemini`](../packages/llm/llm-gemini) | `llm` | [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`settings`](../packages/settings/settings) |
