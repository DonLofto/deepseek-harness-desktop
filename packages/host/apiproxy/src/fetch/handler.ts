...
import { llmDiscoverModelsRequestSchema, llmModelsRequestSchema, llmProvidersRequestSchema, llmStartOAuthLoginRequestSchema } from '../api/llm.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'llm.startOAuthLogin': { schema: llmStartOAuthLoginRequestSchema, invoke: (api, r, signal) => api.llm.startOAuthLogin(r, signal) },
}
