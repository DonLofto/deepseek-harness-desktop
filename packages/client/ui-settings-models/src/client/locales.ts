...
export const en = {
  ...
  presets: 'Presets',
  preset: 'Preset',
  presetId: 'Preset ID (e.g. @preset/deepseek)',
  presetName: 'Display name',
  presetNamePlaceholder: 'Uses the preset ID when empty',
  addPreset: 'Add preset',
  removePreset: 'Delete preset',
  presetsEmpty: 'No custom presets configured.',
  presetIdRequired: 'Preset ID is required.',
  presetIdDuplicate: 'Preset ID must be unique.',
  presetReasoning: 'Enable thinking / reasoning',
  ...
  fetchSearchPlaceholder: 'Filter models…',
  fetchEmptySearch: 'No matching models found.',
  ...
  loginWithOAuth: 'Log in with {provider}',
  loginWaiting: 'Waiting for browser login…',
  loginSuccess: 'Logged in via {provider}.',
  loginFailed: 'Login failed: {error}',
  oauthConfigured: 'OAuth authenticated',
  orApiKey: 'or enter API key manually',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  presets: '预设',
  preset: '预设',
  presetId: '预设 ID (例如 @preset/deepseek)',
  presetName: '显示名称',
  presetNamePlaceholder: '留空时使用预设 ID',
  addPreset: '添加预设',
  removePreset: '删除预设',
  presetsEmpty: '尚未配置自定义预设。',
  presetIdRequired: '预设 ID 不能为空。',
  presetIdDuplicate: '预设 ID 不能重复。',
  presetReasoning: '启用思考 / 推理',
  ...
  fetchAdopt: '添加所选',
  fetchSearchPlaceholder: '过滤模型…',
  fetchEmptySearch: '未找到匹配的模型。',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
  ...
  loginWithOAuth: '使用 {provider} 登录',
  loginWaiting: '正在等待浏览器登录…',
  loginSuccess: '已通过 {provider} 成功登录。',
  loginFailed: '登录失败：{error}',
  oauthConfigured: 'OAuth 已认证',
  orApiKey: '或手动输入 API 密钥',
}
